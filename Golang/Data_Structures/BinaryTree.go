    ...
    for {
        if val > currentNode.val {
            if currentNode.right == nil {
                currnetNode.right = &Node{val: val}
                return
            }
...
func (tree *BinaryTree) InorderTraversal(subTree *BinaryTree) {
    if subTree.left != nil {
...
func (tree *BinaryTree) PreorderTraversal(subTree *BinaryTree) {
    fmt.Print(subTree.val)
    if (subTree.left != nil) {
...
func (tree *BinaryTree) PostorderTraversal(subTree *BinaryTree) {
    if (subTree.left != nil) {
